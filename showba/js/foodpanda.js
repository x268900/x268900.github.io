        ...
        function calculate() {
            ...
            stepsElement.innerHTML = `
                ...
                <div class="calculation-step">
                    ...
                    <span class="value">${value2}</span> = <span class="value">${baseResult}</span>
                </div>
                
                ${applyDiscount ? `
                <div class="calculation-step">
                    折扣狀態: <span class="discount">以應用折扣</span>
                </div>
               <!--- <div class="calculation-step">
                ...
                ` : `
                <div class="calculation-step">
                    折扣狀態: <span class="discount">為應用折扣</span>
                </div>
                `}
                
                <div class="calculation-step final-result">
                    最终结果: <span class="value">${finalResult}</span>
                </div>
            `;
